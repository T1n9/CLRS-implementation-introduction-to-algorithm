...
void toBack(vInt& array,int a,int b)
{
    ...
    //beware of the erase action in vector. it is very inefficient in vector to execute such action.
    //a version without insert is shown in in chapter 9 of randomized select
}
